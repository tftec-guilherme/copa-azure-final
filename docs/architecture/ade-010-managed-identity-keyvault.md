...
> **Status:** ✅ Accepted · **Refina ADE-009 Inv 2 para execução manual** · v1.0
> **Date:** 2026-07-02
...
| **`sql-connection-string`** | connection string SQL (hoje com **senha**) | McpServer **+** Functions | `SqlConnectionString` |
...
- **P-2:** typo no `sql-connection-string` (server/db/keyword) → apps não conectam → 500 nas rotas de compra/consulta. Mitigação: copiar exato; validar McpServer/Functions **antes** de seguir.
